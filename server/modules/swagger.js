    ...
    definitions: {
          ...
          study_Detail_Info: {
            ...
            properties: {
              ...
              who_open: {
                type: "string",
                description:
                  "해당 스터디를 개설한 유저의 nick 이다 (닉네임 O 로그인할때 아이디 X)",
              },
              study_title: {
                type: "string",
                description:
              ...
              study_category: {
                type: "string",
                description:
                  "해당 스터디의 주제이다 ex) 프로그래밍 , 디자인 , 보컬댄스",
              },
              study_detail_description: {
                type: "string",
                description:
                  "해당 스터디 모집글의 상세 설명이다 ex) 30대 분들만 모셔갑니다~~",
              },
              current_member_cnt: {
                type: "integer",
      ...
      apiCloseStudy_ResponseForm_Failed: {
        properties: {
          ...
          message: {
            type: "string",
            description: `실패 하면 study delete 중 알수없는 에러가 서버내에서 발생 : error 또는 이미 삭제된 데이터일수 있습니다 라는 메세지가 리턴된다 도커 젠킨스 확인좀..다시`,
          },
        },
      },
    },
